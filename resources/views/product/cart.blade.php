...
@section('content')
    ...
    @endif
    <table class="table table-hover text-center font-weight-bold bg-light" style="font-weight: bold;color: black;">
    <!--<table id="cart" class="table table-hover table-condensed">-->
        ...
        <tr >
            <td><a href="{{ route('show')}}" class="btn btn-warning btn-lg" style="font-size:15px;font-weight: bolder;margin-left: 100%;background-color: black" ><i class="fa fa-angle-left" ></i> Continue Shopping</a></td>
